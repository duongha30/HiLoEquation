...
export const Card = ({ card, faceDown = false, droppable = false, draggable = false, onMount, translateX }: CardProps) => {
  const { ref: dragRef, isDragging } = useDraggable({ id: card.id, disabled: !draggable });
